...
const (
	...
	PIXELFORMAT_YV12          PixelFormat = 842094169  // YUV 4:2:0 8-bit planar mode: Y + V + U  (3 planes)
	PIXELFORMAT_IYUV          PixelFormat = 1448433993 // YUV 4:2:0 8-bit planar mode: Y + U + V  (3 planes)
	PIXELFORMAT_YUY2          PixelFormat = 844715353  // YUV 4:2:0 8-bit packed mode: Y0+U0+Y1+V0 (1 plane)
	PIXELFORMAT_UYVY          PixelFormat = 1498831189 // YUV 4:2:0 8-bit packed mode: U0+Y0+V0+Y1 (1 plane)
	PIXELFORMAT_YVYU          PixelFormat = 1431918169 // YUV 4:2:0 8-bit packed mode: Y0+V0+Y1+U0 (1 plane)
	PIXELFORMAT_NV12          PixelFormat = 842094158  // YUV 4:2:0 8-bit planar mode: Y + U/V interleaved  (2 planes)
	PIXELFORMAT_NV21          PixelFormat = 825382478  // YUV 4:2:0 8-bit planar mode: Y + V/U interleaved  (2 planes)
	PIXELFORMAT_P010          PixelFormat = 808530000  // YUV 4:2:0 16-bit planar mode: Y + U/V interleaved  (2 planes)
...
const (
	...
	GAMEPAD_BUTTON_MISC1          GamepadButton = 15 // Additional button (e.g. Xbox Series X share button, PS5 microphone button, Nintendo Switch Pro capture button, Steam Controller QAM button, Amazon Luna microphone button, Google Stadia capture button)
	GAMEPAD_BUTTON_RIGHT_PADDLE1  GamepadButton = 16 // Upper or primary paddle, under your right hand (e.g. Xbox Elite paddle P1, DualSense Edge RB button, Right Joy-Con SR button, Steam Controller R4 button)
	GAMEPAD_BUTTON_LEFT_PADDLE1   GamepadButton = 17 // Upper or primary paddle, under your left hand (e.g. Xbox Elite paddle P3, DualSense Edge LB button, Left Joy-Con SL button, Steam Controller L4 button)
	GAMEPAD_BUTTON_RIGHT_PADDLE2  GamepadButton = 18 // Lower or secondary paddle, under your right hand (e.g. Xbox Elite paddle P2, DualSense Edge right Fn button, Right Joy-Con SL button, Steam Controller R5 button)
	GAMEPAD_BUTTON_LEFT_PADDLE2   GamepadButton = 19 // Lower or secondary paddle, under your left hand (e.g. Xbox Elite paddle P4, DualSense Edge left Fn button, Left Joy-Con SR button, Steam Controller L5 button)
